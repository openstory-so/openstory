...
# Optional: ELEVENLABS_API_KEY for native TTS / Voice Design / Music (platform key only).
# =============================================================================
`;
 ...
 * app-image.tsx, and preview/production detection in src/platform/server/env/environment.ts —
