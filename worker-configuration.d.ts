/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d3851a0e65721aad125a88cc6f3e0aa2)
// Runtime types generated with workerd@1.20260911.1 2025-11-18 nodejs_compat
interface __BaseEnv_Env {
	R2_PUBLIC_ASSETS_BUCKET: R2Bucket;
	R2_STORAGE_BUCKET: R2Bucket;
	DB: D1Database;
	SEND_EMAIL: SendEmail;
	DEVICE_LOGIN_RATE_LIMITER: RateLimit;
	MCP_JWT_RATE_LIMITER: RateLimit;
	ADMIN_EMAILS: string;
	API_KEY_ENCRYPTION_KEY: string;
	ARK_API_KEY: string;
	BETTER_AUTH_SECRET: string;
	BYTEPLUS_ACCESS_KEY: string;
	BYTEPLUS_ASSET_SLOTS: string;
	...
	STUDIO_WORKFLOW: Workflow<Parameters<import("./src/server").StudioGenerationWorkflow['run']>[0]['payload']>;
	E2E_TEST?: "true";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "RealtimeChannel" | "BytePlusGovernor";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_EMAILS" | "API_KEY_ENCRYPTION_KEY" | "ARK_API_KEY" | "BETTER_AUTH_SECRET" | "BYTEPLUS_ACCESS_KEY" | "BYTEPLUS_ASSET_SLOTS" | "BYTEPLUS_SECRET_KEY" | "DOPPLER_CONFIG" | "DOPPLER_ENVIRONMENT" | "DOPPLER_PROJECT" | "ELEVENLABS_API_KEY" | "EMAIL_FROM" | "FAL_BILLING_KEY" | "FAL_KEY" | "FAL_PRICING_KEY" | "GEMINI_API_KEY" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "LANGFUSE_BASE_URL" | "LANGFUSE_PROMPTS_ENABLED" | "LANGFUSE_PUBLIC_KEY" | "LANGFUSE_SECRET_KEY" | "OPENAI_API_KEY" | "OPENROUTER_KEY" | "R2_ACCESS_KEY_ID" | "R2_ACCOUNT_ID" | "R2_BUCKET_NAME" | "R2_SECRET_ACCESS_KEY" | "STRIPE_PUBLISHABLE_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "TWILIO_ACCOUNT_SID" | "TWILIO_AUTH_TOKEN" | "TWILIO_VERIFY_SERVICE_SID" | "VITE_APP_NAME" | "VITE_PUBLIC_POSTHOG_HOST" | "VITE_PUBLIC_POSTHOG_PROJECT_TOKEN" | "VITE_R2_PUBLIC_ASSETS_DOMAIN" | "XAI_API_KEY" | "E2E_TEST">> {}
}
