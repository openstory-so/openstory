...
- likeness — "fictional" for a made-up person (including a stylised or cartoon person). "none" for animals, robots, creatures, vehicles-as-characters, and non-human cartoons. Never "real": that is stamped later from a signed talent or an uploaded portrait. A narrator is usually a human voice: likeness fictional.
