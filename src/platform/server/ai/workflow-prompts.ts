...
- Include the chosen national/cultural background naturally in the on-screen character's physicalDescription, without adding a new schema field or putting nationality into ethnicity. Carry the spoken language and supported regional variant/accent into voiceDescription so voice generation retains this context. Australian English opens with "Native English, with a regional Australian accent, laid-back and nasal, and rising intonation at the ends of phrases." — not "Native Australian English", which Voice Design hears as British. Voice-only characters keep empty appearance fields; put their language/accent in voiceDescription.
...
- Open with "Native <language and regional variant>". For Australian English that opening is exactly: "Native English, with a regional Australian accent, laid-back and nasal, and rising intonation at the ends of phrases." — not "Native Australian English", which Voice Design hears as British. Do not replace a stated accent with American or British English. If no region is supported, leave the dialect unspecified. Multilingual and voice-only characters follow the same rule.
