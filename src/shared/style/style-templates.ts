...
import { getPublicAssetsDomain } from '@/shared/storage/public-assets';
...
export const DEFAULT_STYLE_TEMPLATES: StyleTemplateEntry[] = [
  ...
  },
  {
    ...
    config: {
      ...
      motion: {
        camera: 'Slow, deliberate movements with meaningful close-ups',
      },
      references: [
  ...
  },
  {
    ...
    config: {
      ...
      motion: {
        camera: 'Handheld camera with observational framing',
      },
      references: [
  ...
  },
  {
    ...
    config: {
      ...
      motion: {
        camera: 'Fast cuts, sweeping crane shots, and dynamic angles',
      },
      references: [
  ...
  },
  {
    ...
    config: {
      ...
      motion: {
        camera: 'Smooth movements with intimate framing',
      },
      references: [
  ...
  },
  {
    ...
    config: {
      ...
      motion: {
        camera: 'Dutch angles and voyeuristic framing',
      },
      references: [
  ...
  },
  {
    ...
    config: {
      ...
      motion: {
        camera: 'Centered framing, tracking shots, and planimetric composition',
      },
      references: [
  ...
  },
  {
    ...
    config: {
      ...
      motion: {
        camera: 'Smooth camera movements with wide establishing shots',
      },
      references: [
  ...
  },
  {
    ...
    config: {
      ...
      motion: {
        camera: 'Unsettling angles and slow zooms',
      },
      references: [
  ...
  },
  {
    ...
    config: {
      ...
      look: {
        ...
        artStyle:
          'Classic Western with wide landscapes and raking sunset light',
      ...
      motion: {
        camera: 'Wide shots, slow zooms, and classic Western framing',
      },
      references: [
...
// Templates are authored as v2; a test in style-config.test.ts parses every
// entry so a bad template fails here instead of at seed time.
