...
import { SCRIPT_SHORT_THRESHOLD } from '@/models/should-enhance';
import { useDraftGenerationEstimate } from '@/sequences/ui/use-draft-generation-estimate';
...
import {
  markPendingIntent,
  takePendingIntent,
} from '@/sequences/ui/generation/pending-generate';
...
export const ScriptView: FC<{
  ...
  // the dialog does not ship the estimator; the dialog quotes the selected
  // slice.
