...
vi.doMock('@/platform/server/crypto/api-key-encryption', async () => {
  const actual = await vi.importActual<
    typeof import('@/platform/server/crypto/api-key-encryption')
  >('@/platform/server/crypto/api-key-encryption');
