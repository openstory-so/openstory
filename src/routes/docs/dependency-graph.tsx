    ...
    <article className="flex flex-col gap-8">
      ...
      <div className="prose dark:prose-invert max-w-none text-sm">
        <p>
          ...
          <strong>untracked</strong> and never stale. Renders record which{' '}
          <em>version</em> of a prompt or sheet they used, so selecting a
          different version is what makes them stale, not editing the text.
        </p>
      </div>
      <DependencyGraphView
        node={node}
